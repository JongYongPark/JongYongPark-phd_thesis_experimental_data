...
function [t_signal_sec, tx_bin_signal,tx_sym, tx_signal,rx_signal,rx_signal_conv,rx_signal_awgn_with_delay] = ...
    vlc_frame_to_signal(modulation, Rb,Fs, n_bit_frame,tx_bin,chan,snr,tx_amplitude,receiver_power)
...
%    t_signal_symb = 1:Fs*n_bit_frame/Rb*2 ;
    ...
    if contains(modulation, 'OOK_NRZ')
        tx_sym = tx_bin;
    elseif contains(modulation, 'OOK_RZ')
        tx_sym = Bin2Rz(tx_bin);
    elseif contains(modulation, 'OOK_Manchester')
    ...
    rx_signal_conv = conv(tx_sym_signal, chan);
...
function [t_signal_sec, tx_bin_signal,tx_sym, tx_signal,rx_signal,rx_signal_conv,rx_signal_awgn_with_delay] = ...
    vlc_frame_to_signal_mimo(modulation, Rb,Fs, n_bit_frame,tx_bin,impulse_responses_with_powers,snr,tx_amplitude,receiver_power)
...
%    t_signal_symb = 1:Fs*n_bit_frame/Rb*2 ;
    ...
    for i=1:rows
        rx_signal_conv_xx = conv(tx_sym_signal(i,:), impulse_responses_with_powers(i,:));
...
function vlc_snr_test()
   ...
   modulation,mimo_chan_num,Rb);
    ...
    impulse_responses_with_powers   = vlc_get_impulse_response_with_receiver_powers( receiver_power_siso * amp_offset , chan_loss, chan_k, chan_time);
        ...
        while ((bit_errors_sum < error_threshold) && (frame_counter*n_bit_msg*log2(M) < max_bits))
            ...
            for I = 1:batch_size
                ...
                [tx_bin, rx_bin,tx_bin_mimo, rx_bin_mimo, tx_bin_mimo_fix, rx_bin_mimo_fix, rx_bin_mimo_fix_recoverd ] = vlc_tx_rx_message( ...
                    ...
                    impulse_responses_with_powers,snr,tx_amplitude,receiver_power_siso,receiver_power_mimo, ...
...
%     tx_bin = [ 1,0,1,0,1,1,0,0,1,0 ];
    ...
    [t_signal_sec_mimo, tx_bin_signal_mimo, tx_sym_mimo, tx_signal_mimo,rx_signal_mimo, rx_signal_conv_mimo,rx_signal_awgn_with_delay_mimo] = ...
            vlc_frame_to_signal_mimo(modulation,Rb,Fs,n_bit_mimo_frame, tx_bin_mimo,impulse_responses_with_powers,snr,tx_amplitude,receiver_power_mimo);
    %% MIMO Fix    
     [t_signal_sec_mimo_fix, tx_bin_signal_mimo_fix, tx_sym_mimo_fix, tx_signal_mimo_fix,rx_signal_mimo_fix, rx_signal_conv_mimo_fix,rx_signal_awgn_with_delay_mimo_fix] = ...
            vlc_frame_to_signal_mimo(modulation,Rb,Fs,n_bit_mimo_fix_frame, tx_bin_mimo_fix,impulse_responses_with_powers,snr,tx_amplitude,receiver_power_mimo);
...
function vlc_test_packet()
   ...
   modulation,mimo_chan_num,Rb);
    ...
    impulse_responses_with_powers_siso   = vlc_get_impulse_response_with_receiver_powers( receiver_power_siso .* amp_offset , chan_loss, chan_k, chan_time);
    impulse_responses_with_powers   = vlc_get_impulse_response_with_receiver_powers( receiver_powers .* amp_offset , chan_loss, chan_k, chan_time);
...
%     tx_bin = [ 1,0,1,0,1,1,0,0,1,0 ];
    ...
    [t_signal_sec_mimo, tx_bin_signal_mimo, tx_sym_mimo, tx_signal_mimo,rx_signal_mimo, rx_signal_conv_mimo,rx_signal_awgn_with_delay_mimo] = ...
            vlc_frame_to_signal_mimo(modulation,Rb,Fs,n_bit_mimo_frame, tx_bin_mimo,chan,snr,tx_amplitude,receiver_power_mimo);
    
    %{    
    [t_signal_sec_mimo_1, tx_bin_signal_mimo_1, tx_sym_mimo_1, tx_signal_mimo_1,rx_signal_mimo_1, rx_signal_conv_mimo_1,rx_signal_awgn_with_delay_mimo_1] = ...
            vlc_frame_to_signal(modulation,Rb,Fs,n_bit_mimo_frame, tx_bin_mimo(1,:),chan,snr,tx_amplitude,receiver_powers(1));
    [t_signal_sec_mimo_2, tx_bin_signal_mimo_2, tx_sym_mimo_2, tx_signal_mimo_2,rx_signal_mimo_2, rx_signal_conv_mimo_2,rx_signal_awgn_with_delay_mimo_2] = ...
            vlc_frame_to_signal(modulation,Rb,Fs,n_bit_mimo_frame, tx_bin_mimo(2,:),chan,snr,tx_amplitude,receiver_powers(2));
    [t_signal_sec_mimo_3, tx_bin_signal_mimo_3, tx_sym_mimo_3, tx_signal_mimo_3,rx_signal_mimo_3, rx_signal_conv_mimo_3,rx_signal_awgn_with_delay_mimo_3] = ...
            vlc_frame_to_signal(modulation,Rb,Fs,n_bit_mimo_frame, tx_bin_mimo(3,:),chan,snr,tx_amplitude,receiver_powers(3));
    [t_signal_sec_mimo_4, tx_bin_signal_mimo_4, tx_sym_mimo_4, tx_signal_mimo_4,rx_signal_mimo_4, rx_signal_conv_mimo_4,rx_signal_awgn_with_delay_mimo_4] = ...
            vlc_frame_to_signal(modulation,Rb,Fs,n_bit_mimo_frame, tx_bin_mimo(4,:),chan,snr,tx_amplitude,receiver_powers(4));
    %}
     ...
     [t_signal_sec_mimo_fix, tx_bin_signal_mimo_fix, tx_sym_mimo_fix, tx_signal_mimo_fix,rx_signal_mimo_fix, rx_signal_conv_mimo_fix,rx_signal_awgn_with_delay_mimo_fix] = ...
            vlc_frame_to_signal_mimo(modulation,Rb,Fs,n_bit_mimo_fix_frame, tx_bin_mimo_fix,chan,snr,tx_amplitude,receiver_power_mimo);
        
    %{
    [t_signal_sec_mimo_fix_1, tx_bin_signal_mimo_fix_1, tx_sym_mimo_fix_1, tx_signal_mimo_fix_1,rx_signal_mimo_fix_1, rx_signal_conv_mimo_fix_1,rx_signal_awgn_with_delay_mimo_fix_1] = ...
            vlc_frame_to_signal(modulation,Rb,Fs,n_bit_mimo_fix_frame, tx_bin_mimo_fix(1,:),chan,snr,tx_amplitude,receiver_powers(1));
    [t_signal_sec_mimo_fix_2, tx_bin_signal_mimo_fix_2, tx_sym_mimo_fix_2, tx_signal_mimo_fix_2,rx_signal_mimo_fix_2, rx_signal_conv_mimo_fix_2,rx_signal_awgn_with_delay_mimo_fix_2] = ...
            vlc_frame_to_signal(modulation,Rb,Fs,n_bit_mimo_fix_frame, tx_bin_mimo_fix(2,:),chan,snr,tx_amplitude,receiver_powers(2));
    [t_signal_sec_mimo_fix_3, tx_bin_signal_mimo_fix_3, tx_sym_mimo_fix_3, tx_signal_mimo_fix_3,rx_signal_mimo_fix_3, rx_signal_conv_mimo_fix_3,rx_signal_awgn_with_delay_mimo_fix_3] = ...
            vlc_frame_to_signal(modulation,Rb,Fs,n_bit_mimo_fix_frame, tx_bin_mimo_fix(3,:),chan,snr,tx_amplitude,receiver_powers(3));
    [t_signal_sec_mimo_fix_4, tx_bin_signal_mimo_fix_4, tx_sym_mimo_fix_4, tx_signal_mimo_fix_4,rx_signal_mimo_fix_4, rx_signal_conv_mimo_fix_4,rx_signal_awgn_with_delay_mimo_fix_4] = ...
            vlc_frame_to_signal(modulation,Rb,Fs,n_bit_mimo_fix_frame, tx_bin_mimo_fix(4,:),chan,snr,tx_amplitude,receiver_powers(4));
    ...
    [rx_signal_recostructed_mimo ,rx_sym_mimo,rx_bin_mimo,rx_coding_error_mimo,rx_coding_error_total_mimo,rx_sym_signal_mimo,rx_bin_signal_mimo, mimo_chan_err ] = ...
        vlc_signal_to_frame_mimo(modulation,Rb,Fs,n_bit_mimo_frame,mimo_chan_num,rx_signal_awgn_with_delay_mimo,'rx_level_detector_1_sample_per_symbol');    
    %{
    [rx_signal_recostructed_mimo_1 ,rx_sym_mimo_1,rx_bin_mimo_1,rx_coding_error_mimo_1,rx_coding_error_total_mimo_1,rx_sym_signal_mimo_1,rx_bin_signal_mimo_1, mimo_chan_err_1 ] = ...
        vlc_signal_to_frame(modulation,Rb,Fs,n_bit_mimo_frame,mimo_chan_num,rx_signal_awgn_with_delay_mimo_1);
    [rx_signal_recostructed_mimo_2 ,rx_sym_mimo_2,rx_bin_mimo_2,rx_coding_error_mimo_2,rx_coding_error_total_mimo_2,rx_sym_signal_mimo_2,rx_bin_signal_mimo_2, mimo_chan_err_2 ] = ...
        vlc_signal_to_frame(modulation,Rb,Fs,n_bit_mimo_frame,mimo_chan_num,rx_signal_awgn_with_delay_mimo_2);
    [rx_signal_recostructed_mimo_3 ,rx_sym_mimo_3,rx_bin_mimo_3,rx_coding_error_mimo_3,rx_coding_error_total_mimo_3,rx_sym_signal_mimo_3,rx_bin_signal_mimo_3, mimo_chan_err_3 ] = ...
        vlc_signal_to_frame(modulation,Rb,Fs,n_bit_mimo_frame,mimo_chan_num,rx_signal_awgn_with_delay_mimo_3);
    [rx_signal_recostructed_mimo_4 ,rx_sym_mimo_4,rx_bin_mimo_4,rx_coding_error_mimo_4,rx_coding_error_total_mimo_4,rx_sym_signal_mimo_4,rx_bin_signal_mimo_4, mimo_chan_err_4 ] = ...
        vlc_signal_to_frame(modulation,Rb,Fs,n_bit_mimo_frame,mimo_chan_num,rx_signal_awgn_with_delay_mimo_4);

    
    %rx_signal_recostructed_mimo = zeros(0,0);
    rx_signal_recostructed_mimo = [rx_signal_recostructed_mimo_1; rx_signal_recostructed_mimo_2; rx_signal_recostructed_mimo_3; rx_signal_recostructed_mimo_4 ] ;        
    rx_coding_errorrx_coding_error_total_mimo = [ rx_coding_error_total_mimo_1 rx_coding_error_total_mimo_2 rx_coding_error_total_mimo_3 rx_coding_error_total_mimo_4] ;
    
    rx_sym_mimo = [ rx_sym_mimo_1 ; rx_sym_mimo_2 ; rx_sym_mimo_3 ; rx_sym_mimo_4 ];
    rx_bin_mimo = [ rx_bin_mimo_1 ; rx_bin_mimo_2 ; rx_bin_mimo_3 ; rx_bin_mimo_4 ];
    ...
    %{
    [rx_signal_recostructed_mimo_fix_1 ,rx_sym_mimo_fix_1,rx_bin_mimo_fix_1,rx_coding_error_mimo_fix_1,rx_coding_error_total_mimo_fix_1,rx_sym_signal_mimo_fix_1,rx_bin_signal_mimo_fix_1, mimo_fix_chan_err_1  ] = ...
        vlc_signal_to_frame(modulation,Rb,Fs,n_bit_mimo_fix_frame,mimo_chan_num,rx_signal_awgn_with_delay_mimo_fix_1);
    [rx_signal_recostructed_mimo_fix_2 ,rx_sym_mimo_fix_2,rx_bin_mimo_fix_2,rx_coding_error_mimo_fix_2,rx_coding_error_total_mimo_fix_2,rx_sym_signal_mimo_fix_2,rx_bin_signal_mimo_fix_2, mimo_fix_chan_err_2  ] = ...
        vlc_signal_to_frame(modulation,Rb,Fs,n_bit_mimo_fix_frame,mimo_chan_num,rx_signal_awgn_with_delay_mimo_fix_2);
    [rx_signal_recostructed_mimo_fix_3 ,rx_sym_mimo_fix_3,rx_bin_mimo_fix_3,rx_coding_error_mimo_fix_3,rx_coding_error_total_mimo_fix_3,rx_sym_signal_mimo_fix_3,rx_bin_signal_mimo_fix_3, mimo_fix_chan_err_3  ] = ...
        vlc_signal_to_frame(modulation,Rb,Fs,n_bit_mimo_fix_frame,mimo_chan_num,rx_signal_awgn_with_delay_mimo_fix_3);
    [rx_signal_recostructed_mimo_fix_4 ,rx_sym_mimo_fix_4,rx_bin_mimo_fix_4,rx_coding_error_mimo_fix_4,rx_coding_error_total_mimo_fix_4,rx_sym_signal_mimo_fix_4,rx_bin_signal_mimo_fix_4, mimo_fix_chan_err_4  ] = ...
        vlc_signal_to_frame(modulation,Rb,Fs,n_bit_mimo_fix_frame,mimo_chan_num,rx_signal_awgn_with_delay_mimo_fix_4);
    
    rx_sym_mimo_fix = [ rx_sym_mimo_fix_1 ; rx_sym_mimo_fix_2 ; rx_sym_mimo_fix_3 ; rx_sym_mimo_fix_4 ];
    rx_bin_mimo_fix = [ rx_bin_mimo_fix_1 ; rx_bin_mimo_fix_2 ; rx_bin_mimo_fix_3 ; rx_bin_mimo_fix_4];
    ...
    %% SISO display
    siso_title = "OOK Manchester Rb=" + Rb + " Fs="+ Fs + " Led Num=" + LED_num_siso + " Tx/Rx distance=" + LED_height_distance + " Theta="  + LED_theta + " SNR="  + snr + " Received Power="+receiver_power;
    vlc_draw_tx_rx_signal(siso_title,t_signal_sec,tx_bin,tx_bin_signal,tx_signal,rx_signal,rx_signal_awgn_with_delay(1:length(rx_signal)),rx_sym_signal,rx_bin_signal);
 ...
 %   rx_sym = symbol_
    return
 %   show_bit_count =5;
 %   DrawBinaryStream_stem(tx_bin,-0.1,1.1)
 %   DrawSignalByCount(tx_bin,Rb,Fs,show_bit_count)
 %   DrawSignal(tx_bin,tx_sym, Rb, Rs, 1 , 10)
...
function impulse_responses_with_powers = vlc_get_impulse_response_with_receiver_powers( amplitude, loss, k, time_vector)

    [rows,cols] = size(amplitude); 
    impulse_responses_with_powers = zeros(0,0);
...
%     chan = chan / chan(6);
    ...
    for i=1:rows
        ...
        impulse_responses_with_powers = [impulse_responses_with_powers ; chan ];
    end
end 
...
function conv_ExponentialDecaying_new(x,sampleFreq,amplitude,loss,k,time_vector) 
    ...
    impulse_responses_with_powers = vlc_get_impulse_response_with_receiver_powers( amplitude, loss, k, time_vector)
    y = conv(p_x,impulse_responses_with_powers);


    subplot(2,5,[1 2]);stem(p_x);axis([1 length(p_x) -1.5 1.5]);title("tx signal"); grid on
    subplot(2,5,3);stem(chan,'MarkerFaceColor',[0 0 1]);axis([1 length(impulse_responses_with_powers) -0.5 0.5]);title("chan"); grid on
    ...
    subplot(2,5,8);stem(chan,'MarkerFaceColor',[0 0 1]);axis([1 length(impulse_responses_with_powers) -0.5 0.5]);title("chan"); grid on
