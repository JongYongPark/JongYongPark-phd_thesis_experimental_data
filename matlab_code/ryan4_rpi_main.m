...
% https://kr.mathworks.com/matlabcentral/answers/281156-how-can-i-export-a-matrix-as-a-csv-file
csvwrite('ryan4_rpi_indexAll_.csv',idxAll)
writematrix(idxAll,'ryan4_rpi_indexAll.csv') 
