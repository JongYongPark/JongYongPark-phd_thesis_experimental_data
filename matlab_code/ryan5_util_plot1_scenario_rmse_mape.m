function [result_scenario_summary,rmse_val_2digit,mape_val_2digit] = ryan5_util_plot1_scenario_rmse_mape( rul_observed, rul_predicted, rul_ape, soh_observed, soh_ref,  title_str, show_regend, rmse_val, mape_val)
