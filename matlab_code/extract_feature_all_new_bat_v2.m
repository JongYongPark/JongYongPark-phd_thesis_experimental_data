function [info_str, cycle_index, summary,chargeI,dischargeI,VTcharge, VTdischarge,VT_leng ] = extract_feature_all_new_bat_v2(batchNum,batNum,B)
...
% cap 에서 하나의 index 가 빠진다. 하지만 일단 무시해도 된다.
    ...
    for cycleNum = 2: cycle_life-1  
            ...
            VTdischarge(cycle_index, :) = [vTemp, iTemp, tTemp];   
            VTdischargeIndex(cycle_index, :) = [vTemp_leng,iTemp_leng,tTemp_leng];
