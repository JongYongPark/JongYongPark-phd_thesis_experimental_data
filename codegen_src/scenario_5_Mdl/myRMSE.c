 ...
 * myRMSE.c
 *
 * Code generation for function 'myRMSE'
 *
 */
...
double myRMSE(const double z[5], const double zfit[5])
{
  double y[5];
  int k;
  ...
  return sqrt(((((y[0] + y[1]) + y[2]) + y[3]) + y[4]) / 5.0);
}

/* End of code generation (myRMSE.c) */
