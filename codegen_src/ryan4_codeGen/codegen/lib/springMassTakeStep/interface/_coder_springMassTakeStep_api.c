 ...
 *
 * _coder_springMassTakeStep_api.c
 *
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "springMassTakeStep",                                 /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
static real_T emlrt_marshallIn(const emlrtStack *sp, const mxArray *xi,
                               ...
                               const char_T *identifier)
{
  ...
  y = b_emlrt_marshallIn(sp, emlrtAlias(xi), &thisId);
                            ...
                            const mxArray *plhs[2])
{
  ...
  xi = emlrt_marshallIn(&st, emlrtAliasP(prhs[0]), "xi");
  vi = emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "vi");
  ti = emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "ti");
...
void springMassTakeStep_atexit(void)
{
  ...
  springMassTakeStep_xil_terminate();
  springMassTakeStep_xil_shutdown();
...
/* End of code generation (_coder_springMassTakeStep_api.c) */
