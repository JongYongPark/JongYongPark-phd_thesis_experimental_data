...
% Raspberry Pi(TM) Hardware to perform basic operations on the hardware such
...
% with the support package. To update the Raspberry Pi firmware, follow the steps as described in <docid:raspberrypiio_ug.mw_ce00da2f-bde9-4f39-a69a-a9aaf014dbc0 Hardware Setup>.
