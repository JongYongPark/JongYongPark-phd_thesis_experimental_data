...
%% plot - residuals 
%{
% draw bar overwarpped. not easy to identify
figure
plotResiduals(mdl5)
hold on 
...
% https://kr.mathworks.com/matlabcentral/answers/4074-rmse-root-mean-square-error
% https://kr.mathworks.com/matlabcentral/answers/234047-plot-mean-square-error

%%
% https://kr.mathworks.com/matlabcentral/answers/27944-plotting-rmse
% not works
%{
dt = 0.1;
k = length(capacity5);
